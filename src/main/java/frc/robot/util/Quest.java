...
//Stolen from 7028: https://github.com/STMARobotics/frc-7028-2024/blob/andy/QuestNav/src/main/java/frc/robot/QuestNav.java
...
public class Quest {
  ...
  private final Transform2d robotToQuest = new Transform2d(-0.0762, 0.2939, new Rotation2d(3*Math.PI/4));
